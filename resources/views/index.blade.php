        ...
        <div class="h-screen flex flex-wrap">
            ...
            <section class="w-full h-full bg-primary" id="home">
                <div class="xs:p-5 xs:relative xs:top-16">
                    ...
                    {{-- * Content --}}
                        ...
                        <p class="text-white xs:text-xl mt-6 text-2xl">
                            I'm Arif Laksonodhewo. Welcome to my <span class="text-tertiary font-extrabold">portofolio</span> page
                        </p>
            ...
            <section class="w-full h-1/2 bg-tertiary p-5 relative order-4" id="about">
                ...
                <div class="xs:relative xs:top-6">
                    ...
                    <p class="xs:text-sm text-background xs:mt-3 xs:text-center">
                        Right now i'm currently studying web development as fullstack
                ...
                <div class="xs:absolute xs:bottom-0 xs:right-1 xs:p-5">
                    ...
                    <div class=" relative bottom-12">
                        ...
                        <p class="text-background xs:text-sm text-center xs:mt-3">
                            Basic PHP, Basic Javascript, Laravel, MySQL, TailwindCSS, Git,
                            Googling Skills.
                        </p>
                    </div>
                    {{-- * End Content --}}
                ...
                <div class="xs:absolute xs:bottom-0 xs:right-1 p-5">
                    ...
                    <div class="xs:relative bottom-12" >
                        ...
                        <p class="text-background xs:text-sm text-center mt-3">
                            Vue.js, Inertia.js, Single Page Impelementation(SPA), API
                            Implementation.
                        </p>
                    </div>
                    {{-- * End Content --}}
            ...
            <section class="w-full h-1/2 bg-primary order-2 p-5" id="secondary-expertise">
                ...
                <div class="relative top-14">
                    <p class="text-4xl xs:text-5xl text-center text-background">
                    ...
                    <p class="text-background xs:text-sm mt-3 text-center">
                        JMeter, Katalon Studio(Web Testing).
                    </p>
                </div>
                {{-- * End Content --}}
            ...
            <section id="projects" class="w-full max-h-full xs:h-full bg-primary order-5 p-5">
                    ...
                    {{-- * Card --}}
                    <div class="xs:max-w-xs xs:mx-auto xs:rounded-t-xl xs:overflow-hidden xs:mt-5 xs:mb-6">
                        ...
                        {{-- * Arrow Down --}}
                        <div class="xs:w-9 xs:h-9 xs:rounded-full xs:relative xs:bottom-5 xs:left-1/2 xs:-translate-x-1/2 bg-secondary xs:flex xs:justify-center xs:animate-pulse">
                            <a href="#contacts" class="xs:relative xs:top-1.5 text-white"> 
